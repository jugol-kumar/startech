<template>
    <div class="range-slider">
        <div class="d-flex align-items-center justify-content-between">
            <input type="number" v-model="sliderMinValue" :min="props.startMin" :max="props.startMax" @blur="changePriceRange"/>
            <input type="number" v-model="sliderMaxValue" :min="props.startMin" :max="props.startMax" @blur="changePriceRange"/>
        </div>
